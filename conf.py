...
BLOG_AUTHOR = "Tayler Geiger"  # (translatable)
BLOG_TITLE = "Tayler Geiger"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://taylergeiger.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://taylergeiger.com/"
BLOG_EMAIL = "mail@tayler.me"
BLOG_DESCRIPTION = "Portfolio and blog of a writer and developer."  # (translatable)
